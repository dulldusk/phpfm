...
function et($tag){
    ...
    $et['id']['Version'] = 'Versi';
    $et['id']['DocRoot'] = 'Root Dokumen';
    $et['id']['FMRoot'] = 'Root File Manager';
    $et['id']['DateFormat'] = 'Format Tanggal';
    $et['id']['GetSize'] = 'Hitung Ukuran';
    $et['id']['Error'] = 'Kesalahan';
    $et['id']['Name'] = 'Nama';
    $et['id']['And'] = 'dan';
    $et['id']['Enter'] = 'Masukkan';
    $et['id']['Send'] = 'Kirim';
    $et['id']['Refresh'] = 'Segarkan';
    ...
    $et['id']['Move'] = 'Pindahkan';
    $et['id']['Copy'] = 'Salin';
    $et['id']['ServerInfo'] = 'Info Server';
    $et['id']['CreateDir'] = 'Buat Direktori';
    $et['id']['CreateArq'] = 'Buat File';
    $et['id']['Symlink'] = 'Symlink';
    $et['id']['HardLink'] = 'Hardlink';
    $et['id']['ExecCmd'] = 'Jalankan Perintah';
    $et['id']['Upload'] = 'Unggah';
    $et['id']['UploadEnd'] = 'Unggahan Selesai';
    $et['id']['Perm'] = 'Izin';
    $et['id']['Perms'] = 'Izin Akses';
    $et['id']['Owner'] = 'Pemilik';
    $et['id']['Group'] = 'Grup';
    $et['id']['Other'] = 'Lainnya';
    $et['id']['Size'] = 'Ukuran';
    ...
    $et['id']['StickyBit'] = 'Sticky Bit';
    $et['id']['Pass'] = 'Kata Sandi';
    $et['id']['Lang'] = 'Bahasa';
    $et['id']['File'] = 'File';
    $et['id']['File_s'] = 'File';
    $et['id']['Dir_s'] = 'Direktori';
    $et['id']['To'] = 'Ke';
    ...
    $et['id']['SelDir'] = 'Pilih direktori tujuan pada panel kiri';
    $et['id']['TypeDir'] = 'Masukkan nama direktori';
    $et['id']['TypeArq'] = 'Masukkan nama file';
    $et['id']['TypeCmd'] = 'Masukkan perintah';
    $et['id']['TypeArqComp'] = 'Masukkan nama file.\\nEkstensi akan menentukan tipe kompresi.\\nContoh:\\nnama.zip\\nnama.tar\\nnama.bzip\\nnama.gzip';
    $et['id']['RemSel'] = 'Hapus item yang dipilih?';
    $et['id']['NoDestDir'] = 'Tidak ada direktori tujuan yang dipilih';
    $et['id']['DestEqOrig'] = 'Direktori sumber dan tujuan sama';
    $et['id']['InvalidDest'] = 'Direktori tujuan tidak valid';
    $et['id']['NoNewPerm'] = 'Izin akses baru belum diatur';
    $et['id']['CopyTo'] = 'Salin ke';
    $et['id']['MoveTo'] = 'Pindahkan ke';
    $et['id']['AlterPermTo'] = 'Ubah Izin Akses untuk';
    $et['id']['ConfExec'] = 'Konfirmasi Eksekusi';
    $et['id']['ConfRem'] = 'Konfirmasi Penghapusan';
    $et['id']['EmptyDir'] = 'Direktori kosong';
    $et['id']['IOError'] = 'Kesalahan I/O';
    $et['id']['FileMan'] = 'PHP File Manager';
    $et['id']['InvPass'] = 'Kata sandi salah';
    $et['id']['ReadDenied'] = 'Akses baca ditolak';
    $et['id']['FileNotFound'] = 'File tidak ditemukan';
    $et['id']['AutoClose'] = 'Tutup otomatis setelah selesai';
    $et['id']['OutDocRoot'] = 'File berada di luar DOCUMENT_ROOT';
    $et['id']['NoCmd'] = 'Kesalahan: Perintah tidak diberikan';
    $et['id']['ConfTrySave'] = 'File tidak memiliki izin tulis.\\nAnda tetap ingin mencoba menyimpan?';
    $et['id']['ConfSaved'] = 'Konfigurasi telah disimpan';
    $et['id']['PassSaved'] = 'Kata sandi telah disimpan';
    $et['id']['FileDirExists'] = 'File atau direktori sudah ada';
    $et['id']['NoPhpinfo'] = 'Fungsi phpinfo() dinonaktifkan';
    $et['id']['NoReturn'] = 'Tidak ada output';
    $et['id']['FileSent'] = 'File berhasil dikirim';
    $et['id']['SpaceLimReached'] = 'Batas ruang disk telah tercapai';
    $et['id']['InvExt'] = 'Ekstensi tidak valid';
    $et['id']['FileNoOverw'] = 'File tidak dapat ditimpa';
    $et['id']['FileOverw'] = 'File berhasil ditimpa';
    $et['id']['FileIgnored'] = 'File diabaikan';
    $et['id']['ChkVer'] = 'Periksa Versi Baru';
    $et['id']['ChkVerAvailable'] = 'Versi baru tersedia! Klik di sini untuk mengunduh.';
    $et['id']['ChkVerNotAvailable'] = 'Anda sudah menggunakan versi terbaru.';
    $et['id']['ChkVerError'] = 'Gagal terhubung ke server pembaruan.';
    $et['id']['Website'] = 'Situs Web';
    $et['id']['SendingForm'] = 'Mengirim file, mohon tunggu...';
    $et['id']['NoFileSel'] = 'Tidak ada file yang dipilih';
    $et['id']['SelAll'] = 'Pilih Semua';
    $et['id']['SelNone'] = 'Batalkan Pilihan';
    $et['id']['SelInverse'] = 'Balikkan Pilihan';
    $et['id']['Selected_s'] = 'terpilih';
    $et['id']['Total'] = 'Total';
    $et['id']['Partition'] = 'Partisi';
    $et['id']['RenderTime'] = 'Waktu render halaman';
    $et['id']['Seconds'] = 'detik';
    $et['id']['ErrorReport'] = 'Laporan Kesalahan';
    $et['id']['Close'] = 'Tutup';
    $et['id']['SetPass'] = 'Atur Kata Sandi';
    $et['id']['ChangePass'] = 'Ubah Kata Sandi';
    $et['id']['Portscan'] = 'Port Scan';
    $et['id']['PHPOpenBasedir'] = 'PHP open_basedir';
    $et['id']['PHPOpenBasedirFullAccess'] = '(Tidak diatur) Akses Penuh';
    $et['id']['About'] = 'Tentang';
    $et['id']['FileSaved'] = 'File berhasil disimpan';
    $et['id']['FileSaveError'] = 'Terjadi kesalahan saat menyimpan file';
