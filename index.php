...
function et($tag){
   ...
   // Bahasa Indonesia - by dirmanhana
    ...
    $et['id']['Decompress'] = ' Decompress ';
    $et['id']['ResolveIDs'] = 'Resolve ID ';
    $et['id']['Move'] = 'Pindah';
    $et['id']['Copy'] = 'Salinan';
    $et['id']['ServerInfo'] = ' Server Info ';
    $et['id']['CreateDir'] = 'Create Direktori ';
    $et['id']['CreateArq'] = 'Create Berkas ';
    $et['id']['Symlink'] = ' Symlink ';
    $et['id']['HardLink'] = ' Hardlink ';
    $et['id']['ExecCmd'] = 'Execute Command ';
    $et['id']['Upload'] = ' Upload ';
    $et['id']['UploadEnd'] = 'Upload Selesai ';
    $et['id']['Perm'] = ' Perm ';
    $et['id']['Perms'] = ' Izin ';
    $et['id']['Owner'] = 'Pemilik';
    ...
    $et['id']['Lang'] = 'Bahasa';
    $et['id']['File'] = 'Mengajukan';
    $et['id']['File_s'] = 'file (s) ';
    $et['id']['Dir_s'] = 'directory (s) ';
    $et['id']['To'] = 'to'; 'untuk';
    $et['id']['Destination'] = 'Tujuan';
    $et['id']['Configurations'] = ' Konfigurasi ';
    $et['id']['JSError'] = 'JavaScript Kesalahan ';
    $et['id']['NoSel'] = 'There yang tidak dipilih item ';
    $et['id']['SelDir'] = 'Select direktori tujuan di pohon sebelah kiri ';
    $et['id']['TypeDir'] = 'Enter nama direktori ';
    $et['id']['TypeArq'] = 'Enter nama file ';
    $et['id']['TypeCmd'] = 'Enter perintah ';
    $et['id']['TypeArqComp'] = 'Enter nama file \\ ekstensi nThe akan menentukan jenis kompresi \\ Nex:.. \\ nnome.zip \\ nnome.tar \\ nnome.bzip \\ nnome.gzip ';
    $et['id']['RemSel'] = 'DELETE dipilih item ';
    $et['id']['NoDestDir'] = 'There sudah tidak dipilih direktori tujuan ';
    $et['id']['DestEqOrig'] = 'Origin dan tujuan direktori adalah sama ';
    $et['id']['InvalidDest'] = 'direktori Destination tidak valid ';
    $et['id']['NoNewPerm'] = 'izin New tidak diatur ';
    $et['id']['CopyTo'] = 'Salin ke';
    $et['id']['MoveTo'] = 'Pindah ke';
    $et['id']['AlterPermTo'] = 'CHANGE Perizinan untuk ';
    $et['id']['ConfExec'] = 'Confirm Jalankan ';
    $et['id']['ConfRem'] = 'Confirm DELETE ';
    $et['id']['EmptyDir'] = 'Empty direktori ';
    ...
    $et['id']['AutoClose'] = 'Close pada Lengkap ';
    $et['id']['OutDocRoot'] = 'File luar DOCUMENT_ROOT ';
    $et['id']['NoCmd'] = 'Error: Command tidak diberitahu ';
    $et['id']['ConfTrySave'] = 'File tanpa menulis permisson \\ nCoba untuk menyimpan pula ';
    $et['id']['ConfSaved'] = 'Configurations disimpan ';
    $et['id']['PassSaved'] = 'Password disimpan ';
    $et['id']['FileDirExists'] = 'File atau direktori sudah ada ';
    $et['id']['NoPhpinfo'] = 'Function phpinfo ' cacat;
    $et['id']['NoReturn'] = 'no kembali ';
    $et['id']['FileSent'] = 'File mengirim ';
    $et['id']['SpaceLimReached'] = 'Batas Space mencapai ';
    $et['id']['InvExt'] = 'Invalid ekstensi ';
    $et['id']['FileNoOverw'] = 'File tidak bisa ditimpa ';
    $et['id']['FileOverw'] = 'File ditimpa ';
    $et['id']['FileIgnored'] = 'File diabaikan ';
    $et['id']['ChkVer'] = 'Check untuk versi baru ';
    ...
    $et['id']['SendingForm'] = 'Sending file, silakan tunggu ';
    $et['id']['NoFileSel'] = 'Tidak ada file yang dipilih';
    $et['id']['SelAll'] = 'Semua';
    $et['id']['SelNone'] = ' Tidak ';
    $et['id']['SelInverse'] = 'Terbalik';
    $et['id']['Selected_s'] = 'terpilih';
    $et['id']['Total'] = 'total';
    $et['id']['Partition'] = ' Partition ';
    $et['id']['RenderTime'] = 'Time untuk membuat halaman ini ';
    $et['id']['Seconds'] = 'detik';
    $et['id']['ErrorReport'] = 'Error Pelaporan ';
    $et['id']['Close'] = 'Menutup';
    ...
    $et['id']['FileSaveError'] = 'Error menyimpan file ';
